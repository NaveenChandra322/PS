            ...
            if (fileList.length) {
                for (i; i < fileList.length; i++) {
                    ...
                    try {
                        ...
                        if(err.message.includes('ECONNREFUSED') || err.message.includes('AbortController')){
                            return rej('Unable to upload file(s) to IPFS. Please check if the service is running.');
                        }
                    ...
                    if (fileAdded != undefined) {
                        ...
                        rej('Unable to upload file(s) to IPFS, please check if the service is running.')
                    }
                }
                ...
                if (fileAdded != undefined) {
                    ...
                    throw('Unable to upload file(s) to IPFS, please check if the service is running.')
                }
            }
