import { API_ADD_EMPLOYEE, HTTP_HEADER, API_GET_ALL_EMPLOYEES, 
    API_GET_EMP_DETAILS, API_ADD_PRIVATE_DATA, API_GET_EMP_PVT_DATA, HTTP_HEADER_FORMDATA,
    API_GET_EMP_IPFS_FILE, API_DELETE_EMP} from './Constants.js';
...
const GetEmpDetails = async (PropID) => {
    try {
...
const DeleteEmployee = async (PropID) => {
    try {
...
const GetEmpPvtRecords = async (PropID) => {
    try {
